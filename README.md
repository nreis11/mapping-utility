...
IMPORTANT: When updating Mapping Utilty, do not remove or replace the PHP index file:

```
/var/www/equest2/ui/htdocs/mapping/index.php
```

The rest of the files at this location can be replaced.
