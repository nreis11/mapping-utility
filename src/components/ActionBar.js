            ...
            <div className="col-sm-2 text-center">
              <ButtonGroup style={buttonGroupStyle}>
                <Button bsStyle="primary" block>
                  <FaForward /> Map <FaForward /><br />
                  (single)
                </Button>
                <Button bsStyle="primary" block>
                  <FaForward /> Map Node <FaForward /><br />
                  (preserve)
                </Button>
                <Button bsStyle="primary" block>
                  <FaForward /> Map Node <FaForward /><br />
              ...
              <ButtonGroup style={buttonGroupStyle}>
                <Button bsStyle="primary"><FaBackward /></Button>
                <Button disabled>Expand All</Button>
                <Button bsStyle="primary"><FaForward />
                </Button>
              </ButtonGroup>
              <ButtonGroup style={buttonGroupStyle}>
                <Button bsStyle="primary"><FaBackward /></Button>
                <Button disabled>Collapse All</Button>
                <Button bsStyle="primary"><FaForward /></Button>
              </ButtonGroup>
            </div>
        )
    }
